...
const RTSPRecorder = class {
  ...
  stopRecording() {
    ...
    console.log(this.logTime(), process.pid, chalk.bold.green('[RECORD]'),'Gravação salva em (' + fileName + ')');
  }
  ...
  recordStream() {
    ...
    console.log(this.logTime(), process.pid, chalk.bold.red('[RECORD]'),'Gravação iniciada em (' + fileName + ')');
  }
}
